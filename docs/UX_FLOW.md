...
**주요 UI 요소**:
- AppBar: "설정" 제목
- **배경 (Atmosphere)**: 2열 그리드 — 10개 배경 프리셋 미니 프리뷰 (Free 2 + Premium 8)
- **앱 테마 (팔레트)**: 3열 그리드 — 6개 색상 팔레트 (Free 2 + Premium 4)
- **휠 테마**: 4열 그리드 — 8개 휠 렌더링 스타일 (Free 2 + Premium 6)
- **언어**: 시스템 + 6개 언어 옵션
- **피드백**: 사운드 팩 선택 + 햅틱 강도
- **스핀 시간**: short/normal/long
- **앱 정보**: 버전, 오픈소스 라이선스, 문의하기

**액션**:
| 액션 | 결과 |
|------|------|
| Atmosphere 프리뷰 카드 탭 (Free) | 배경 즉시 변경, 설정 저장 |
| Atmosphere 프리뷰 카드 탭 (잠금) | 잠금 다이얼로그 → "프리미엄 알아보기" → 페이월 |
| 앱 팔레트 카드 탭 | 팔레트 즉시 변경, 설정 저장 |
| 휠 테마 카드 탭 | 휠 스타일 즉시 변경, 설정 저장 |
| 사운드 토글 | 즉시 설정 저장 |
| 진동 토글 | 즉시 설정 저장 |
| 오픈소스 라이선스 탭 | Flutter 기본 라이선스 페이지 |
| 문의하기 탭 | 이메일 앱 실행 |

> **참고**: 라이트/다크 모드 전환 UI 없음. 항상 다크 베이스 고정.
